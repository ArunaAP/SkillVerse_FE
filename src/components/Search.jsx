    ...
    <section className="relative flex items-center justify-between max-w-7xl z-20 mx-auto md:px-12">
      <div className="relative w-full py-4">
        <div className="flex items-center space-x-4 py-4 rounded-full w-full">
          <button className="bg-gray-50 bg-opacity-40 text-gray-600 px-4 py-2 rounded-full shadow">
            <i className="fa-solid fa-sliders"></i> Filter
          </button>

          <div className="flex items-center flex-grow bg-gray-50 bg-opacity-50 px-4 py-2 rounded-full shadow">
            <i className="fa-solid fa-magnifying-glass text-gray-600 mr-2"></i>
            <input
              type="text"
              className="flex-grow focus:outline-none bg-transparent text-gray-800 w-full"
