...
const AddDesignForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-10">
      <h1 className="text-2xl font-bold text-gray-700 mb-6">Add New Design</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className={`w-full py-2 px-4 text-white bg-blue rounded-md focus:outline-none hover:bg-blue-700 ${
            loading ? 'opacity-50 cursor-not-allowed' : ''
          }`}
          disabled={loading}
        >
          {loading ? 'Submitting...' : 'Add Design'}
        </button>
